...
class MyCardsFragment : Fragment(), OnItemClickListener {
    ...
    private fun initializeElements() {
        ...
        val card1 =
            Card(
                "1", "1", AppLevelFunctions.getCurrentUserID(), ArrayList(), "First commit", "12 Dec",
                "16 Dec", 1, "Details", "Description", 0
            )
        val card2 =
            Card(
                "2", "1", AppLevelFunctions.getCurrentUserID(), ArrayList(), "Splash screen", "13 Oct",
                "19 Dec", 2, "Details", "Description", 0
            )
        val card3 =
            Card(
                "3","2", AppLevelFunctions.getCurrentUserID(), ArrayList(), "TestCard", "01 Oct",
                "31 Dec", 3, "Details", "Description", 0
            )
        val board1 = Board("1", "Szoftver Projekt", 1, arrayListOf(AppLevelFunctions.getCurrentUserID()),1)
        val board2 = Board("2", "Test", 2, arrayListOf(AppLevelFunctions.getCurrentUserID()), 1)
...
//        Firestore().addCard(this,card1)

        Firestore().getAllCardsCreatedByUser(this)
